...
int main(){
	...
	while(T--){
		...
		int k = 16;
		cin >> a.num >> b.num;
		if(a.num[0] == '-') a.num = string(a.num.begin() + 1, a.num.end()), a.sign = -1;
		else a.sign = 1;
		if(b.num[0] == '-') b.num = string(b.num.begin() + 1, b.num.end()), b.sign = -1;
		else b.sign = 1;
		c.sign = cmp(a, b);
		cout << ((a.sign < 0) ? "-" : "") << a.num << (c.sign < 0 ? " < " : (c.sign == 0 ? " = " : " > ")) << ((b.sign < 0) ? "-" : "") << b.num << endl;
		c = add(a, b);
		cout << ((a.sign < 0) ? "-" : "") << a.num << " + " << ((b.sign < 0) ? "-" : "") << b.num << " = " << ((c.sign < 0) ? "-" : "") << c.num << endl;
		c = sub(a, b);
		cout << ((a.sign < 0) ? "-" : "") << a.num << " - " << ((b.sign < 0) ? "-" : "") << b.num << " = " << ((c.sign < 0) ? "-" : "") << c.num << endl;
		c = mul1(a, k);
		cout << ((a.sign < 0) ? "-" : "") << a.num << " x " << k << " = " << ((c.sign < 0) ? "-" : "") << c.num << endl;
		c = mul2(a, b);
		cout << ((a.sign < 0) ? "-" : "") << a.num << " x " << ((b.sign < 0) ? "-" : "") << b.num << " = " << ((c.sign < 0) ? "-" : "") << c.num << endl;
		c = bigDiv1(a, k);
		cout << ((a.sign < 0) ? "-" : "") << a.num << " : " << k << " = " << ((c.sign < 0) ? "-" : "") << c.num << " (Div) "<< endl;
		c.sign = bigMod1(a, k);
		cout << ((a.sign < 0) ? "-" : "") << a.num << " : " << k << " = " << c.sign << " (Mod) " << endl;
		c = bigDiv2(a, b);
		cout << ((a.sign < 0) ? "-" : "") << a.num << " : " << ((b.sign < 0) ? "-" : "") << b.num << " = " << ((c.sign < 0) ? "-" : "") << c.num << " (Div) "<< endl;
		c = bigMod2(a, b);
		cout << ((a.sign < 0) ? "-" : "") << a.num << " : " << ((b.sign < 0) ? "-" : "") << b.num << " = " << ((c.sign < 0) ? "-" : "") << c.num << " (Mod) "<< endl;
	}
}
/*
9
